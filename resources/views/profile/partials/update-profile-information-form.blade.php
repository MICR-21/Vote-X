    ...
    <section>
        ...
        <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
            ...
            <div>
                ...
                <!-- Preview area for selected image -->
                <div class="mt-2">
                    <img id="image-preview" src="{{ $user->profile_photo_path ? asset('storage/' . $user->profile_photo_path) : 'https://via.placeholder.com/150' }}" alt="Profile Image" class="image-preview rounded-full">
                </div>
